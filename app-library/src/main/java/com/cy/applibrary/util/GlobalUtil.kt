...
object GlobalUtil {
    ...
    val appPackage: String
        get() = MemoryStore.Instance.getData<Context>(GlobalKeys.APPLICATION_CONTEXT).packageName
    ...
    fun getAppIcon(): Drawable {
        val packageManager = MemoryStore.Instance.getData<Context>(GlobalKeys.APPLICATION_CONTEXT).packageManager
