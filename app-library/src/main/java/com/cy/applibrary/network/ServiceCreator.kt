...
import com.cy.applibrary.extension.logV
import com.cy.applibrary.extension.screenPixel
...
object ServiceCreator {
    ...
    val BASE_URL = Eyepetizer.getConfiguration<String>(GlobalKeys.API_HOST)
    ...
    private object RestServiceHolder{
        internal val REST_SERVICE = retrofit.create(RestService::class.java)
    }
