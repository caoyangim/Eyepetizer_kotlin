package com.cy.eyepetizer.ui.home.commend.adapter
...
import com.cy.applibrary.Const
import com.cy.applibrary.extension.*
import com.cy.applibrary.util.ActionUrlUtil
import com.cy.applibrary.util.GlobalUtil
import com.cy.eyepetizer.BuildConfig
import com.cy.eyepetizer.R
import com.cy.eyepetizer.logic.model.Item
import com.cy.eyepetizer.ui.hodel.*
import com.cy.eyepetizer.ui.home.commend.CommendFragment
import com.shuyu.gsyvideoplayer.listener.GSYSampleCallBack
import com.shuyu.gsyvideoplayer.video.base.GSYVideoPlayer
import jp.wasabeef.glide.transformations.RoundedCornersTransformation

class CommendAdapter(val fragment:CommendFragment,val datalist:List<Item>):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder = RecyclerViewHelp.getViewHolder(parent,viewType)
...
//                holder.tvFollow.setOnClickListener { LoginActivity.start(fragment.activity) }
            ...
            is VideoSmallCardViewHolder -> {
                ...
                holder.tvDescription.text = if (item.data.library == "DAILY") "#${item.data.category} / 开眼精选" else "#${item.data.category}"
